...
public class FileUtil implements Comparator<File> {
	 ...
	 */
	public static final String HOMEDIR = "files/TextFiction/";
...
//		File root = Environment.getExternalStorageDirectory();
		File root = new File("/storage/emulated/0/Android/data/com.yuriyu.textfiction/");
	...
	private static void ensureDirs(){
		Log.i("FileUtils", "file; " + library.toString());
		library.mkdirs();
		saves.mkdirs();
		data.mkdirs();
	}
