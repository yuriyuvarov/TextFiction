...
class ImportTask extends AsyncTask<Object, Integer, Exception> implements
	...
	private ImportTask() {
//		myViewModel = new ViewModelProvider(master.requireActivity()).get(MyViewModel.class);
	}
	 ...
	 *
	 * @param master the fragment to report back to in case something was imported.
     */
